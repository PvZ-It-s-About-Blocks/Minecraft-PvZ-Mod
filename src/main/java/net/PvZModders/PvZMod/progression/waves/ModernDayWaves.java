...
public final class ModernDayWaves {
    ...
    private static List<WaveReward> rewardsFor(int wave) {
        return switch (wave) {
            ...
            case 18 -> List.of(new WaveReward(WaveRewardType.PLAYER_UPGRADE, "final_sun_cap", "Final Sun Cap Upgrade", "minecraft:chorus_fruit", "World-wide: permanently grants the final easy-mode maximum Sun increase."));
            case 22 -> plant("grimrose", "Grimrose", "pvz2mod:grimrose_seed_packet", "Drags normal zombies into the shadows.");
            case 25 -> List.of(new WaveReward(WaveRewardType.PLAYER_UPGRADE, "final_seed_holder", "Final Seed Holder Upgrade", "minecraft:end_stone", "World-wide: finalizes easy-mode Seed Holder capacity and second-page slots."));
            case 27 -> List.of(
                    new WaveReward(WaveRewardType.GARDEN_UPGRADE, "minimum_starting_sun_3", "Starting Sun Upgrade III", "minecraft:ender_eye", "World-wide: raises the minimum Sun players begin a wave with to 150."),
                    new WaveReward(WaveRewardType.GARDEN_UPGRADE, "final_garden_storage", "Final Garden Storage Upgrade", "minecraft:end_stone", "World-wide: final easy-mode totem seed storage upgrade.")
            );
            case 30 -> List.of(
